...
impl Into<Option<gds21::GdsStrans>> for Orientation {
    fn into(self) -> Option<gds21::GdsStrans> {
...
impl From<gds21::GdsStrans> for Orientation {
    fn from(value: gds21::GdsStrans) -> Self {
        Orientation {
            reflect_vert: value.reflected,
            angle: value.angle.unwrap_or(0f64),
        }
    }
}
...
///
/// ```
/// use subgeom::orientation::wrap_angle;
///
